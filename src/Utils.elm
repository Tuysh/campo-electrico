...
colors : { white : E.Color, lightGrey : E.Color, darkGrey : E.Color, black : E.Color }
colors =
    { white =
...
styles : { button : List (E.Attr () msg), tab : List (E.Attr () a), padTop10 : E.Attribute b, padTop20 : E.Attribute c, padBottom20 : E.Attribute d, padBottom10 : E.Attribute e }
styles =
    { button =
